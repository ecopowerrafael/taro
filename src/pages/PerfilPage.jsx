...
export function PerfilPage() {
  ...
  // ─── Menu de navegação ────────────────────────────────────────────────────
  const menuItems = [
    { label: 'Mapa Astral',   icon: '/mapa-astral.png',          to: '/oraculo-diario',      external: false },
    { label: 'Oráculo Diário', icon: '/oraculo.png',             to: '/oraculo-diario?tab=diario', external: false },
