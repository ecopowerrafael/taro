...
const regex = /<img src="\/oraculo\.png"[\s\S]*?Continuar a Jornada\s*<\/button>\s*<\/div>/;

const replacement = \<img src="/mapa-astral.png" alt="Mapa Astral" className="w-32 h-32 mx-auto drop-shadow-[0_0_20px_rgba(255,215,0,0.5)] object-contain" />
              ...
              <div className="mt-8 px-6 pb-6 pt-4 bg-black/40 border border-mystic-gold/20 rounded-2xl max-w-sm mx-auto shadow-[0_0_15px_rgba(255,215,0,0.05)] text-left">
